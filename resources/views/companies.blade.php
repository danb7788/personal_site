...
<section class="text-center">
    <div class="container mt-5">
        <h1>Companies</h1>
        <h2 class="mt-5">Berges Institute</h2>
        <img src="/images/berges.jpg" class="img-fluid" alt="Responsive image">
        ...
        <h2>Dwight</h2>
        <img src="/images/dwight.png" class="img-fluid" alt="Responsive image">
